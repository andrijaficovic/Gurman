        ...
        <div class="row gx-5 justify-content-center">
            <div class="col-lg-8 col-xl-6">
                <div class="text-center">
                    <h2 class="fw-bolder mb-5">Izmeni recepte</h2>
                </div>
            </div>
        </div>
        <div class="row gx-5">
                    ...
                    <div class="col-lg-4 mb-5">
                        <div class="card h-100 shadow border-0">
                            ...
                            <div class="card-body p-4">
                                ...
                                <a class="text-decoration-none link-dark stretched-link" href="edit_recipe.check.php?id=<?php echo $post_id ?>">
                            ...
                            <button type="button" class="btn btn-success fw-bold">Izmeni recept</button>
                        </div>
                    </div>
            <?php }
            } ?>
